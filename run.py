...
class work(QWidget):
    ...
    def display_baidu(self):
        ...
        with open('SCKEY.val', 'w') as f:
            f.write(SCKEY)
        # SCKEY = self.te1.text() if self.te1.text() != '' else 'SCT55216To0rOJvln8HrYv9n6fUXkHhlF'
